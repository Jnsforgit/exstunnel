...
static struct s_x3 *x3a;    /* There is only one instance of the array, which is the following */
static struct s_x2 *x2a;    /* There is only one instance of the array, which is the following */
static struct s_x1 *x1a;    /* There is only one instance of the array, which is the following */
static int size = 0;
/*
